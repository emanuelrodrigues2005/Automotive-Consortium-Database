...
INSERT INTO boleto (
  ...
  ('2024-06-15', NULL, 6, 1500.00, 'PENDENTE', '2024-07-15', 1),
  ('2024-11-20', NULL, 13, 850.50, 'PENDENTE', '2024-12-20', 2),
  ('2023-12-10', '2024-01-08', 24, 1200.00, 'PAGO', '2024-01-10', 3),
  ('2024-11-05', '2024-12-01', 2, 2100.00, 'PAGO', '2024-12-05', 4),
  ('2024-12-05', NULL, 3, 2100.00, 'PENDENTE', '2025-01-05', 4),
  ('2024-10-25', NULL, 7, 900.00, 'VENCIDO', '2024-11-25', 7),
  ('2024-11-01', NULL, 19, 1100.00, 'PENDENTE', '2024-12-01', 8);